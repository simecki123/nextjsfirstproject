...
import { Event, User } from './NotificationComponent';

interface AcceptCoffeComponentProps {
  event: Event;
  eventUser: User;
}

export default function AcceptCoffeComponent({ event, eventUser }: AcceptCoffeComponentProps) {
    ...
    return (
        <div className='border max-w-sm border-gray-300 shadow-lg rounded-lg p-4 bg-stone-200'>
            <div className='flex justify-between items-center mb-4'>
                <p className='text-lg font-semibold'>{eventUser.firstName} {eventUser.lastName} is going to make coffee in 5 minutes. Do you want one too?</p>
